...
const CategoryModal = React.memo<CategoryModalProps>(({ nullable, visible, selected, onChange, onClose }) => {
    ...
    const keyExtractor = React.useCallback((_, index) => `categories-item-${index}`, []);

    const data = React.useMemo(
        () => (nullable ? [{ name: t('select_category_placeholder') }, ...categories] : categories),
        [categories, nullable, t],
    );
